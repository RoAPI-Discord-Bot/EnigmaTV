...
object StreamSources {
    ...
    val tvSources: List<StreamSource> = listOf(
        ...
        StreamSource("Vidsrc.net TV", tvUrl = { id, s, e -> "https://vidsrc.net/embed/tv?tmdb=$id&season=$s&episode=$e" }),
        StreamSource("Vidsrc.me TV",  tvUrl = { id, s, e -> "https://vidsrc.me/embed/tv?tmdb=$id&season=$s&episode=$e" }),
